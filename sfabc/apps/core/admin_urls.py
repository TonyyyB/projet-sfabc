...
urlpatterns = [
    ...
    path("site/apropos/group/add/", apropos_group_add, name="admin_apropos_group_add"),
    path("site/apropos/group/<int:pk>/", apropos_group_edit, name="admin_apropos_group_edit"),
    path("site/apropos/group/<int:pk>/delete/", apropos_group_delete, name="admin_apropos_group_delete"),
    path("site/apropos/group/<int:pk>/move/<str:direction>/", apropos_group_move, name="admin_apropos_group_move"),
