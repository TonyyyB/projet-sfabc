...
class AvisModelTest(TestCase):
    def setUp(self):
        ...
        self.date = datetime.datetime(2025, 12, 17)
        self.avis = Avis.objects.create(produit=self.produit, pseudonyme="test pseudonyme avis", date=self.date, valeur=2, message="test message avis")
    ...
    def test_avis_creation(self):
        ...
        self.assertEqual(self.avis.date,       self.date.date())
    ...
    def test_avis_updating(self):
        ...
        self.update_date = datetime.datetime(2025, 11, 17, 0, 0)
        self.avis.date = self.update_date
        self.avis.valeur = 4
        ...
        self.assertEqual(updated_avis.date,       self.update_date.date())
